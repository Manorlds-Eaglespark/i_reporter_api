...
incident4_data = [3, "intervation", "0.111, 0.344", "Resolved", ["images-link-1","images-link-1"], ["videos-link-1", "videos-link-2"], "Kisasi bypass road has alot of traffic jam."]
...
incident2_data_dictionary = {"created_by": 2, "type": "red-flag", "location": "0.114, 0.342", "status": "Rejected", "images": ["images-link-1", "images-link-1"], "videos": ["videos-link-1", "videos-link-2"], "comment": "National id official Kabulenge Christine wants a bribe"}
incident3_data_dictionary = {"created_by": 2, "type": "intervation", "location": "0.435, 0.034", "status": "under-investigation", "images": ["images-link-1", "images-link-1"], "videos": ["videos-link-1", "videos-link-2"], "comment": "Bunamwaya has no clean water supply."}
