...
from app.data_store.data import incidents, login_user, incident5_data_dictionary, incident1_data_dictionary, incident2_data_dictionary, incident6_data_dictionary, incident3_data_dictionary, new_location, new_comment, new_status, incident3
...
class TestFlaskApi(unittest.TestCase):
    ...
    def test_update_red_flag_status_user_not_admin(self):
        redflag_incident = {
            "type": "red-flag",
            "location": "0.112, 0.545",
            "status": " sdfsd",
