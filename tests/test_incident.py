...
class TestFlaskApi(unittest.TestCase):
    def setUp(self):
        ...
        self.header_old = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NDc1OTUwMjksImlhdCI6MTU0NzU4NzgyOSwic3ViIjoxNjEwNSwiYWRuIjoiRmFsc2UifQ.AxU19wAI4_oPw0vyTgweu7MZ4Bf4VV6tsk4pJK68GrA"
    ...
    def test_delete_red_flag_given_id(self):
        ...
        id = incidents[0].id
        response = self.client.delete('/api/v1/red-flags/'+str(id), headers=self.headers)
        data = json.loads(response.data)
        self.assertEqual(data["status"], 200)
